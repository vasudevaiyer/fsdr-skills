...
- Read [references/governance.md](../../references/governance.md) before any execution workflow.
- Read [references/personas.md](../../references/personas.md) if the user's allowed actions are unclear.
