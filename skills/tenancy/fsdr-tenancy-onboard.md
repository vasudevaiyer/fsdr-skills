...
- Read [references/tenancy-profile.md](../../references/tenancy-profile.md) when building or validating the tenancy context.
...
- Read [references/personas.md](../../references/personas.md) when the user's role is unclear.
