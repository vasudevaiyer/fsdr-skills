...
- Read [references/fsdr-setup-reference.md](../../fsdr-setup-reference.md) for prerequisite and IAM policy guidance.
- Read [references/governance.md](../../governance.md) for approval and execution guardrails.
- Read [references/personas.md](../../personas.md) when the request depends on persona-specific scope.
