...
- Read [references/tenancy-profile.md](../../tenancy-profile.md) to confirm tenancy context fields.
- Read [references/governance.md](../../governance.md) to understand the risk of the next action.
...
- Read [references/fsdr-setup-reference.md](../../fsdr-setup-reference.md) if the user needs a consolidated Oracle-aligned setup summary.
